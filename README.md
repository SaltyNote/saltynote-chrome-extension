...
2. Run `npm run build:dev`, then a `dist` folder will be generated.
3. Go to [chrome://extensions/](chrome://extensions/) page in Chrome, enable `developer mode`, and load the extension from [`dist`](./dist) folder.
